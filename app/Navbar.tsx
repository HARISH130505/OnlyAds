...
function Navbar() {
  const user = useUser();
  return (
    <header className="bg-gradient-to-r from-gray-900 to-indigo-950 text-white py-2 px-6 fixed top-0 w-full z-50 transition-all duration-300 hover:shadow-[0_0_15px_rgba(79,70,229,0.5)]">
